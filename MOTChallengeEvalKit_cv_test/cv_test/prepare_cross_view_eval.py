...
gt_dir = "/home/zyh/data/MOTChallengeEvalKit_cv_test/data/eval/vision/gt"
track_dir = "/home/zyh/data/MOTChallengeEvalKit_cv_test/data/eval/vision/res"
save_dir = "/home/zyh/data/MOTChallengeEvalKit_cv_test/data/eval/vision/result_cvma"

gt_folder = "gt"

gt_box_type = 'xywh' #xyxy for divo xywh for vision
...
for n in range(len(scene_list)):
	...
	for m in range(len(vid_list)):
		...
		# convert format
		gt_data = np.loadtxt(gt_path, delimiter=delimiter, dtype=float)
		max_fr = 0
		...
		track_data = np.loadtxt(track_path, delimiter=track_delimiter, dtype=float)
